 ...
 */
@Component({
  selector: 'lista-solicitacoes-servico',
  templateUrl: 'lista-solicitacoes-servico.html'
})
export class ListSolicitacoesServicoPage {
  ...
  constructor(public nav: NavController,
    ...
    solicitacaoService.findByIdPrestador(this.currentUser.id).subscribe(data => {
      this.items = data;
     console.log(data)
    })
